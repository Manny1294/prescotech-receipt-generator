...
// 🧾 Simple function to download the receipt as PDF
const downloadPDF = () => {
  ...
  <div class="preview-container">
    <div class="preview-actions">
      ...
      <div class="action-buttons">
        ...
        <button @click="$emit('saveReceipt')" class="btn-save">Save Receipt</button>
      </div>
    </div>

    <!-- 👇 This section is what will be captured as a PDF -->
        ...
        <div class="receipt-header-preview">
          <div class="company-info">
            ...
            <!-- <div class="icon-info">
              ...
              <p>preciousoboh22@gmail.com.com</p>
            </div> -->
          </div>
